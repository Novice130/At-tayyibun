    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Log in to continue your journey</p>
        </div>
        ...
        <div className="card">
          ...
          <div className="space-y-3 mb-6">
            <button onClick={handleGoogle} className="btn-outline w-full justify-center gap-2">
            ...
            <button onClick={handleFacebook} className="btn-outline w-full justify-center gap-2">
